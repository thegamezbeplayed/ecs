#ifndef __UTIL_TOOLS__
#define __UTIL_TOOLS__
#include <float.h>
#include "game_math.h"
#include <string.h>
#include <stdint.h>
...
#define VEC_ANG(v1,v2) ((Vector2)Vector2Angle(v1, v2))
#define VEC_DIST(v1,v2) (float)Vector2Distance(v1, v2)
...
static Cell GridIndexCell(int index){
  int x = index / 1000;
  int y = index % 1000;
...
static inline Vector2 cell_to_vec(Cell c, float scale){
